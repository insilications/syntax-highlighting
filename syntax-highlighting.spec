...
Source0  : https://download.kde.org/stable/frameworks/5.76/syntax-highlighting-5.76.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.76/syntax-highlighting-5.76.0.tar.xz.sig
...
%prep
%setup -q -n syntax-highlighting-5.76.0
cd %{_builddir}/syntax-highlighting-5.76.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605429513
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/syntax-highlighting-5.76.0/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/syntax-highlighting/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/syntax-highlighting-5.76.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/syntax-highlighting/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/syntax-highlighting-5.76.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/syntax-highlighting/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/syntax-highlighting-5.76.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/syntax-highlighting/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/syntax-highlighting-5.76.0/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/syntax-highlighting/a0193e3fccf86c17dc71e3f6c0ac0b535e06bea3
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5SyntaxHighlighting.so.5.76.0
