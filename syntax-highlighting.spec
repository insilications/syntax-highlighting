...
Source0  : https://download.kde.org/stable/frameworks/5.66/syntax-highlighting-5.66.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.66/syntax-highlighting-5.66.0.tar.xz.sig
...
%prep
%setup -q -n syntax-highlighting-5.66.0
cd %{_builddir}/syntax-highlighting-5.66.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578948026
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/syntax-highlighting-5.66.0/COPYING %{buildroot}/usr/share/package-licenses/syntax-highlighting/ed938678eaa4f37c45a62a0a3bf65b85547f0a2a
pushd clr-build
%make_install
popd
...
/usr/share/qlogging-categories5/org_kde_ksyntaxhighlighting.categories
...
/usr/lib64/libKF5SyntaxHighlighting.so.5.66.0

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/syntax-highlighting/ed938678eaa4f37c45a62a0a3bf65b85547f0a2a
