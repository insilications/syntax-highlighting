...
Source0  : https://download.kde.org/stable/frameworks/5.63/syntax-highlighting-5.63.0.tar.xz
Source1 : https://download.kde.org/stable/frameworks/5.63/syntax-highlighting-5.63.0.tar.xz.sig
...
%prep
%setup -q -n syntax-highlighting-5.63.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570926371
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5SyntaxHighlighting.so.5.63.0
