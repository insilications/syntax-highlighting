...
Source0  : https://download.kde.org/stable/frameworks/5.64/syntax-highlighting-5.64.0.tar.xz
Source1 : https://download.kde.org/stable/frameworks/5.64/syntax-highlighting-5.64.0.tar.xz.sig
...
%prep
%setup -q -n syntax-highlighting-5.64.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573368964
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/syntax-highlighting-5.64.0/COPYING %{buildroot}/usr/share/package-licenses/syntax-highlighting/ed938678eaa4f37c45a62a0a3bf65b85547f0a2a
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5SyntaxHighlighting.so.5.64.0
