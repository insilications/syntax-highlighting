...
Source0  : https://download.kde.org/stable/frameworks/5.60/syntax-highlighting-5.60.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.60/syntax-highlighting-5.60.0.tar.xz.sig
...
%prep
%setup -q -n syntax-highlighting-5.60.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563051847
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5SyntaxHighlighting.so.5.60.0

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/syntax-highlighting/COPYING
